        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Fostering innovation and creativity in technology and research for the next generation of leaders.
            </p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">
                  College Campus, Innovation Building, <br />
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">info@innovationlab.edu</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} College Innovation Lab. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
